...
7. PHÁT HIỆN LỖI SAI — Nếu học sinh làm sai kiến thức, tính toán hoặc hiểu nhầm khái niệm, hãy ghi nhận trong trường "insight" của response JSON. Chỉ ghi khi HS thực sự sai, KHÔNG ghi nếu chỉ hỏi bài. Ví dụ topic: "Phép cộng phân số", errorType: "Chưa quy đồng mẫu số".
8. KHUYẾN KHÍCH — Nếu HS làm đúng hoặc cố gắng, hãy ghi lời khen ngắn gọn trong trường "encouragement".`);
